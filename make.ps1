...
<#
.Description
Make file for Grafana Publisher
#>
...
#>
function lint() {
    poetry run flake8 src\grafana_publisher tests
}
...
#>
function test() {
    poetry run python test.test_grafana_publisher.py
}
...
#>
function coverage() {
    poetry run coverage run --source src\grafana_publisher -m test.test_grafana_publisher.py
...
#>
function docs(){
    if (Test-Path ".\docs\grafana_publisher.rst") { Remove-Item ".\docs\grafana_publisher.rst" -Force }
    if (Test-Path ".\docs\modules.rst") { Remove-Item ".\docs\modules.rst" -Force }
    poetry run sphinx-apidoc -o docs\ src\grafana_publisher
